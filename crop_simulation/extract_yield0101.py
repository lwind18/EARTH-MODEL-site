...
#read csv file
data1 = pd.read_csv ("crop_location020350.csv")

folder = "/Users/Darren/Desktop/DIS_tools/Q3_wofost/crop_simulation/result02031"
...
for dt in dir_list:
    if dt.endswith ("xlsx"):        
        ws = pd.read_excel(dt)
        yd = ws.iloc[181, 4]  #except row and column name, start from 0 
        yds.append (yd)
    else:
        pass
#print (yds)
